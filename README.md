...
[![Preview](readme_preview/Portfolio-preview.png)](https://NachoMtnz.github.io/Portfolio/)

**A simple, clean, and responsive [Jekyll](https://jekyllrb.com/) theme for academics.**

---

[![deploy](https://github.com/NachoMtnz/Portfolio/actions/workflows/deploy.yml/badge.svg)](https://github.com/NachoMtnz/Portfolio/actions/workflows/deploy.yml)
[![Maintainers](https://img.shields.io/badge/maintainers-4-success.svg)](#maintainers)
[![GitHub contributors](https://img.shields.io/github/contributors/NachoMtnz/Portfolio.svg)](https://github.com/NachoMtnz/Portfolio/graphs/contributors/)
[![Docker Image Version](https://img.shields.io/docker/v/amirpourmand/Portfolio?sort=semver&label=docker%20image&color=blueviolet)](https://hub.docker.com/r/amirpourmand/Portfolio)
[![Docker Image Size](https://img.shields.io/docker/image-size/amirpourmand/Portfolio?sort=date&label=docker%20image%20size&color=blueviolet)](https://hub.docker.com/r/amirpourmand/Portfolio)
[![Docker Pulls](https://img.shields.io/docker/pulls/amirpourmand/Portfolio?color=blueviolet)](https://hub.docker.com/r/amirpourmand/Portfolio)

[![GitHub release](https://img.shields.io/github/v/release/NachoMtnz/Portfolio)](https://github.com/NachoMtnz/Portfolio/releases/latest)
[![GitHub license](https://img.shields.io/github/license/NachoMtnz/Portfolio?color=blue)](https://github.com/NachoMtnz/Portfolio/blob/master/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/NachoMtnz/Portfolio)](https://github.com/NachoMtnz/Portfolio)
[![GitHub forks](https://img.shields.io/github/forks/NachoMtnz/Portfolio)](https://github.com/NachoMtnz/Portfolio/fork)

</div>

## User community

The vibrant community of **Portfolio** users is growing!
...
<a href="https://maruan.NachoMtnz.com" target="_blank">★</a>
...
[![Google Lighthouse PageSpeed Insights](lighthouse_results/desktop/pagespeed.svg)](https://htmlpreview.github.io/?https://github.com/NachoMtnz/Portfolio/blob/master/lighthouse_results/desktop/NachoMtnz_github_io_al_folio_.html)

Run the test yourself: [Google Lighthouse PageSpeed Insights](https://pagespeed.web.dev/report?url=https%3A%2F%2FNachoMtnz.github.io%2FPortfolio%2F&form_factor=desktop)

### Mobile

[![Google Lighthouse PageSpeed Insights](lighthouse_results/mobile/pagespeed.svg)](https://htmlpreview.github.io/?https://github.com/NachoMtnz/Portfolio/blob/master/lighthouse_results/mobile/NachoMtnz_github_io_al_folio_.html)

Run the test yourself: [Google Lighthouse PageSpeed Insights](https://pagespeed.web.dev/report?url=https%3A%2F%2FNachoMtnz.github.io%2FPortfolio%2F&form_factor=mobile)
...
[![CV Preview](readme_preview/cv.png)](https://NachoMtnz.github.io/Portfolio/cv/)
...
[![People Preview](readme_preview/people.png)](https://NachoMtnz.github.io/Portfolio/people/)
...
[![Publications Preview](readme_preview/publications.png)](https://NachoMtnz.github.io/Portfolio/publications/)
...
[![Projects Preview](readme_preview/projects.png)](https://NachoMtnz.github.io/Portfolio/projects/)
...
[![Distill Preview](readme_preview/distill.png)](https://NachoMtnz.github.io/Portfolio/blog/2021/distill/)

For more details on how to create distill-styled posts using `<d-*>` tags, please refer to [the example](https://NachoMtnz.github.io/Portfolio/blog/2021/distill/).

#### Full support for math & code

**Portfolio** supports fast math typesetting through [MathJax](https://www.mathjax.org/) and code syntax highlighting using [GitHub style](https://github.com/jwarby/jekyll-pygments-themes). Also supports [chartjs charts](https://www.chartjs.org/), [mermaid diagrams](https://mermaid-js.github.io/mermaid/#/), and [TikZ figures](https://tikzjax.com/).

<p align="center">
<a href="https://NachoMtnz.github.io/Portfolio/blog/2015/math/" target="_blank"><img src="readme_preview/math.png" width=400></a>
<a href="https://NachoMtnz.github.io/Portfolio/blog/2015/code/" target="_blank"><img src="readme_preview/code.png" width=400></a>
</p>

#### Photos, Audio, Video and more

Photo formatting is made simple using [Bootstrap's grid system](https://getbootstrap.com/docs/4.4/layout/grid/). Easily create beautiful grids within your blog posts and project pages, also with support for [video](https://NachoMtnz.github.io/Portfolio/blog/2023/videos/) and [audio](https://NachoMtnz.github.io/Portfolio/blog/2023/audios/) embeds:

<p align="center">
  <a href="https://NachoMtnz.github.io/Portfolio/projects/1_project/">
...
**Portfolio** uses [github-readme-stats](https://github.com/anuraghazra/github-readme-stats) and [github-profile-trophy](https://github.com/ryo-ma/github-profile-trophy) to display GitHub repositories and user stats on the `/repositories/` page.

[![Repositories Preview](readme_preview/repositories.png)](https://NachoMtnz.github.io/Portfolio/repositories/)
...
**Portfolio** supports preview images on social media. To enable this functionality you will need to set `serve_og_meta` to `true` in your [\_config.yml](_config.yml). Once you have done so, all your site's pages will include Open Graph data in the HTML head element.
...
Contributions to Portfolio are very welcome! Before you get started, please take a look at [the guidelines](CONTRIBUTING.md).
...
<a href="https://contrib.rocks">
  <img src="https://contrib.rocks/image?repo=NachoMtnz/Portfolio&max=500&columns=24" />
</a>

## Star History

<a href="https://star-history.com/#NachoMtnz/Portfolio&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=NachoMtnz/Portfolio&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=NachoMtnz/Portfolio&type=Date" />
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=NachoMtnz/Portfolio&type=Date" />
  </picture>
</a>

## License

The theme is available as open source under the terms of the [MIT License](https://github.com/NachoMtnz/Portfolio/blob/master/LICENSE).

Originally, **Portfolio** was based on the [\*folio theme](https://github.com/bogoli/-folio) (published by [Lia Bogoev](https://liabogoev.com) and under the MIT license). Since then, it got a full re-write of the styles and many additional cool features.
